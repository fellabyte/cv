...
export default function Edu() {
  ...
  return (
    <div className={`justify-center items-start mt-20 sm:mt-40 grid justify-items-center`} >
      ...
      <p className={`mt-10 transition-all duration-300 my-3 mx-7 font-semibold text-center text-md sm:text-lg lg:text-xl xl:text-2xl px-3 py-2 rounded-xl dark:text-white dark:bg-gray-600 bg-slate-200`} > {langg ? lngj.en.edup : lngj.ar.edup} </p>
    </div>
  )
}
