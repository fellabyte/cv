...
export default function Section() {
  ...
  return (
    <div className={`md:pt-60 pt-10 flex justify-center items-center flex-col text-black dark:text-white transition-all duration-300`} >
      <Img src='/images/myh.jpg' sizes='size-44 sm:size-52 lg:size-64 xl:size-80 relative m-3' className='transition-all duration-300 shadow-md  rounded-full' alt='image' />
